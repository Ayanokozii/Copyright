...
async def daxxpapa_boot():
    ...
    await idle()
    print("MADARCHOD BANGYA EDIT KRKE HERO MAR DI REPO KI GAND ABB ISSE APNI MAA KI MRA LE @Kairnex")
    await COPYRIGHT2.send_message(LOGGER_ID, "**𝖨 𝖺𝗆 𝖺𝗅𝗂𝗏𝖾 𝖡𝖺𝖻𝗒 𝖸𝗈𝗎𝗋 𝖡𝗈𝗍 𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅 𝖣𝖾𝗉𝗅𝗈𝗒 \n Mʏ Dᴇᴠᴇʟᴏᴘᴇʀ  [ㅤ~ Kairnex ☠️](https://t.me/Kairnex)**")
